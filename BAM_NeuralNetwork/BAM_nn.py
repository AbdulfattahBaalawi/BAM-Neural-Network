...
if __name__ == "__main__":
    ...
    print('\n')
    print("[1, 0, 1, 0, 1, 0] ---> ", end=" ")
    print(b.get_assoc([1, 0, 1, 0, 1, 0]))
    print()
    print("[1, 0, 0, 0, 1, 0] ---> ", end=" ")
    print(b.get_assoc([1, 0, 0, 0, 1, 0]))
    print()
    print("[1, 1, 1, 0, 0, 0] ---> ", end=" ")
    print(b.get_assoc([1, 1, 1, 0, 0, 0]))